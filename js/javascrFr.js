...
dateString = $.datepicker.formatDate( "mm/dd/yy", $( "#datepicker" ).datepicker( "getDate" ) )        
    ...
    $(".searchButton").click(function (event) {
        ...
        $(".loaded").empty();
             ...
             var q = "";
                q += "<h1 id='serviceHead'>Champ de recherche ne peut pas être vide!</h1>";    
...
q += "<p>"  + getTime(info[0].start_time) + " - " + getTime(info[0].end_time) + "</p>";
    ...
    if (info[0].website !== null && info[0].website !== "") {
        q += "<p>Website: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=" + info[0].website + "id='webpage'>" + info[0].name_fr + "</a></p>";
    } else {};
...
function sendQry() {
    var qry = "http://www.nscss.com/EAConnects/admin/index.php?-table=programs&-sort=name_fr+asc&categories=%3D" + categoryId + "&communities=%3D" + communityId + "&-limit=200&-action=export_json";
...
function sendQryOrg() {
    ...
    var qryServ = "http://www.nscss.com/EAConnects/admin/index.php?-table=Organizations&communities=%3D" + communityId + "&-sort=name_fr+asc&-limit=200&-action=export_json";
...
function searchFunc() {
   ...
   var qrySearch = "http://www.nscss.com/EAConnects/admin/index.php?-action=list&-table=programs&-limit=100&name_fr=" + searchValue + "&-action=export_json";
