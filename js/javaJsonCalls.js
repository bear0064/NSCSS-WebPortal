...
qry = "http://www.nscss.com/EAConnects/admin/index.php?-table=programs&-sort=communities+asc&categories=%3D" + categoryId + "&communities=%3D" + communityId + "&-action=export_json";
